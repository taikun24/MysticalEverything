...
public final class CropResource {
    ...
    private static @Nullable CustomData customData(ItemStack stack) {
    ...
    public boolean equals(Object o) {
        ...
        return switch (type) {
            case ITEM -> {
                ...
                yield this.item.is(that.item.getItem())
                        && Objects.equals(customData(this.item), customData(that.item));
            }
    ...
    public int hashCode() {
        ...
        if (type == TYPE.ITEM) {
            if (!item.isEmpty()) {
                ...
                result = 31 * result + Objects.hashCode(customData(item));
            }
        } else if (fluid != null) {
