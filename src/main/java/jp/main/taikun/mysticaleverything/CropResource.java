    ...
    public boolean equals(Object o) {
        ...
        return switch (type) {
            case ITEM -> {
                ...
                yield item1.is(item2.getItem()) && Objects.equals(item1.getComponents().get(DataComponents.CUSTOM_DATA), item2.getComponents().get(DataComponents.CUSTOM_DATA));
            }
        ...
        if (type == TYPE.ITEM) {
            ...
            if (!itemStack.isEmpty()) {
                ...
                if (itemStack.getComponents().has(DataComponents.CUSTOM_DATA)) {
                    result = 31 * result + Objects.hashCode(itemStack.getComponents().get(DataComponents.CUSTOM_DATA));
                }
            }
