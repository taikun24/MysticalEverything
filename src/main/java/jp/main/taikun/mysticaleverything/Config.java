...
public class Config {
    ...
    static{
        ...
        FILTER_JSON = BUILDER.comment("作物にするアイテムのフィルターJSON。例: {\"type\": \"tag\", \"tag\": \"c:ores\"}").define("filterJson", "{\"type\": \"tag\", \"tag\": \"c:ores\"}");
        ...
        NBT_FILTER_JSON = BUILDER.comment("このフィルターに当たったアイテムだけ disableNBT が逆になる。例: {\"type\": \"tag\", \"tag\": \"c:tools\"}").define("nbtFilterJson", "{\"type\": \"nbt_has_any\"}");
        BUILDER.pop();
