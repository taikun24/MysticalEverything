...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue USE_CUSTOM_FILTER;
    public static final ModConfigSpec.BooleanValue FILTER_WHITELIST;
    public static final ModConfigSpec.ConfigValue<String> FILTER_JSON;
    public static final ModConfigSpec.BooleanValue USE_NBT_FILTER;
    public static final ModConfigSpec.BooleanValue NBT_FILTER_WHITELIST;
    public static final ModConfigSpec.ConfigValue<String> NBT_FILTER_JSON;
    ...
    static{
        ...
        FILTER_JSON = BUILDER.comment("作物にするアイテムのフィルターJSON。useCustomFilter=true のときだけ使う。既定は全アイテム許可。例: {\"type\": \"tag\", \"tag\": \"c:ores\"}").define("filterJson", "{\"type\": \"and\", \"filters\": []}");
        ...
        NBT_FILTER_JSON = BUILDER.comment("このフィルターに当たったアイテムだけ disableNBT が逆になる。useNBTFilter=true のときだけ使う。例: {\"type\": \"tag\", \"tag\": \"c:tools\"}").define("nbtFilterJson", "{\"type\": \"nbt_has_any\"}");
        BUILDER.pop();
